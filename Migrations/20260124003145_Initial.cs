    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Aktuality", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ryby", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RybaId = table.Column<int>(type: "int", nullable: false),
                    LokalitaId = table.Column<int>(type: "int", nullable: false),
                    Delka = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ulovky", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ulovky_Lokality_LokalitaId",
                        column: x => x.LokalitaId,
                        principalTable: "Lokality",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ulovky_Ryby_RybaId",
                        column: x => x.RybaId,
                        principalTable: "Ryby",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ulovky_LokalitaId",
                table: "Ulovky",
                column: "LokalitaId");

            migrationBuilder.CreateIndex(
                name: "IX_Ulovky_RybaId",
                table: "Ulovky",
                column: "RybaId");
        }
